...
**FrontEnd Developer** [NTT Data Europa & Latam] _(Noviembre 2023 - Actualidad)_

- Cambio de tecnología del producto TFWeb en la parte de Caixa arquitectura.
- Análisis funcional del código legacy para su correspondiente implementación en la SPA.
- Implementación de algoritmos de ordenación y modelajes de componentes.
- Implementación de caché usando indexedDB.
- Integración de Scripts en la SPA derivados del JSON de respuesta.
- Documentación y generación de test cases.
- Integración de evolutivos con el micro.
- Realización de pruebas unitarias, de integración y de aceptación.

- **_Tecnologías usadas:_** HTML, CSS, JavaScript, React.js, Jest.

**Full Stack Developer** [Hotel Playa de Regla] _(Junio 2022 - Noviembre 2023)_
...
**Full Stack Developer** [Working my self] _(Marzo 2022 - Noviembre 2023)_
